(function ($) {
    var brandCollection = [
        ...
        { name: "J.", fabric: "Cotton", price: "4000 to 7000", size: "small || medium || large" },
        { name: "GULAHMED", fabric: "Cotton", price: "4000 to 7000", size: "small || medium || large" },
        { name: "ZARA", fabric: "Cotton", price: "4000 to 7000", size: "small || medium || large" }
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class=" relPos compHeader"><p class="w3-display-middle">Features</p></li>' + '<li>BRAND</li>' + '<li>FABRIC</li>' + '<li>PRICE</li>' + '<li class="cpu">SIZE</li>' + '</ul>' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
                $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + title + '</li>' + '<li>' + $(product).data('size') + '</li>' + '<li>' + $(product).data('weight') + '<li class="cpu">' + $(product).data('processor') + '</li>' + '</ul>' + '</div>');
            }
        }
        $(".modPos").show();
    });
